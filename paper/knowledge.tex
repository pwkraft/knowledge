...
Overall, a highly sophisticated individual can be expected to respond to a set of open-ended items by giving a more elaborate response that focuses on multiple political issues and addresses his or her attitudes towards all relevant political actors or policies more or less equally.


% CONTINUE HERE
\section*{Study 1: American National Election Study 2012}
...
\section*{Study 2: YouGov Study on Disease Information Retrieval}
...
% Zaller argues that it captures what actually got into people's minds... that's a perfect argument!
...
\subsection*{Sophistication and Information Retrieval}

\begin{figure}[h]\centering
\includegraphics{../fig/yg_disease.pdf}
\caption{Political knowledge as a determinant of disease information retrieval. Estimates are OLS regression coefficients with 95\% confidence intervals. Dependent variables are the text-based sophistication measure, factual political knowledge as well as knowledge about a fictional disease that was presented as part of the study. Full model results are presented in the appendix, Table~\ref{tab:yg_disease}}\label{fig:yg_disease}
\end{figure}
