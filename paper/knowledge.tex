...
\large{Challenging the Gender Gap in Political Sophistication}\footnote{Prepared for the 7th Annual General Conference of the European Political Science Association
Milan, Italy 22-24 June 2017.
% Previous versions of this manuscript have been presented at the Annual Conference of the Society for Political Methodology (POLMETH), 2016; and the 75th Annual Conference of the Midwest Political Science Association, April 6-9, 2017.
...
% CONTINUE HERE
\section*{Study 1: 2012 American National Election Study}
...
\section*{Study 2: 2015 YouGov Survey}
...
The following analysis will replicate and extend the main results of the previous section using an alternative set of open-ended responses. The data consist of a YouGov online survey of 1000 US citizens that was conducted in December 2015. In this study, respondents were asked to report in a closed format whether they favor or oppose stricter gun laws. Subsequently, they are asked to respond to the following two questions in verbatim:
\begin{itemize}
...
\end{itemize}
Similarly, the respondents report on their attitude towards the Affordable Care Act in a closed format and are then asked to elaborate in their own words by answering the following questions:
\begin{itemize}
\item Still thinking about the question you just answered, what thoughts came to mind while you were answering that question? Please try to list everything that came to mind.
...
Recall that the disease information score is used as an indicator of the ability to retrieve specific information provided in a news article about a public health issue. As such, it could be argued that this ability to incorporate relevant information from news reporting may be a function of political sophistication and knowledge. After all, sophisticates are often characterized by higher political awareness and general news consumption (see also the previous results in Figure~\ref{fig:determinants}).

Figure~\ref{fig:yg_disease} displays the effects of text-based sophistication and factual knowledge on the amount of information retrieval about the infectious disease.


...both measures potentially capture the individual ability to retrieve relevant information about the disease from the news article. 

Text-based sophistication is a stronger predictor of the extent to which participants recalled the information about the fictional disease than general political knowledge.

The text-based sophistication measure is similar to the disease information score in that it captures the extent to which participants were able to recall political information that is relevant to their attitudes. Conventional knowledge scores, on the other hand, inquire about specific that are not necessarily relevant to derive well-informed attitudes about political issues.
...
\caption{Political knowledge and sophistication as a determinant of disease information retrieval. The figure displays expected values of the amount of information correctly recalled about the fictional disease described in a news article depending on text-based sophistication and factual political knowledge (including 95\% confidence intervals). Estimates are based on OLS controlling for gender, education, income, age, race, and religiosity. In the first row, text-based sophistication and factual knowledge are included as independent variables in separate models. The second row displays the respective effects while controlling for the alternative knowledge/sophistication measure. Full model results are presented in the appendix, Table~\ref{tab:yg_disease}}\label{fig:yg_disease}
\end{figure}
...
Again, there is a significant gender gap in factual knowledge (middle), which disappears using the text-based measure (left). The remaining determinants of sophistication are similar across measures (except for family income). Interestingly, the determinants of text-based sophistication are very similar to the determinants of knowledge about the fictional disease that was part of the study (right).

% Make a reference to Jenn's study, which found that gender differences disappear if information is provided to respondents
