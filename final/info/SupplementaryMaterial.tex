...
In addition, I apply the measurement approach using three waves of the American National Election Study (ANES), each consisting of a representative survey of about 5000 adults in the months before the US Presidential election in each year. Here, discursive sophistication is evaluated using a set of 8 open-ended questions in which respondents were asked to list anything in particular that they like/dislike about the Democratic/Republican party as well as anything that might make them vote/not vote for either of the Presidential candidates.
...
The human subjects research in this article was reviewed and approved as exempt by the University of Wisconsin-Milwaukee (UWM IRB\# 20.044). The remaining research relies on secondary analyses of publicly available survey data such as the \citet{anes2012timeseries,anes2016timeseries,anes2020timeseries}, the Cooperative Election Study \citep{ces2018common}, as well as \citet{clifford2018disgust} and \citet{colombo2016justifications}.
...
\begin{figure}[ht]\centering
	\includegraphics[scale = .83]{../out/appB1-wc.pdf}
...
\begin{figure}[ht]\centering
	\includegraphics[scale = .83]{../out/appB2-noresponse.pdf}
...
\input{../out/appC2-determinants_rob_disc}
\input{../out/appC3-determinants_rob_fact}
...
\input{../out/appD01-knoweff2018cces1}
\input{../out/appD02-knoweff2018cces2}
\input{../out/appD03-knoweff2020anes1}
\input{../out/appD04-knoweff2020anes2}
\input{../out/appD05-knoweff2016anes1}
\input{../out/appD06-knoweff2016anes2}
\input{../out/appD07-knoweff2012anes1}
\input{../out/appD08-knoweff2012anes2}
\clearpage
...
\input{../out/appD10-determinants_text}
\input{../out/appD11-determinants_swiss}
\input{../out/appD12-determinants_factual}
