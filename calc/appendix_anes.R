...
m2 <- lm(redist ~ tax * polknow_text_mean + tax * polknow_factual + female + age + black + relig + educ + faminc + ideol_ct + pid_cont, data=data2012)
summary(m2)

summary(lm(redist ~ tax * polknow_text_mean + tax * polknow_factual + female + age + black + relig + educ + faminc + ideol_ct + pid_cont, data=data2016))
