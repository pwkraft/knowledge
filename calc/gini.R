...
round(cbind(sapply(test2, shannon),sapply(test2, gini),sapply(test2, giniNew)),3)
...
round(cbind(sapply(test3,shannon),sapply(test3,gini),sapply(test3, giniNew)),3)
...
round(cbind(sapply(test4,shannon),sapply(test4,gini),sapply(test4, giniNew)),3)
