...
\institute{7th Annual General Conference of the European Political Science Association}
\title{Women Also Know Stuff\\{\large Challenging the Gender Gap in Political Sophistication}}
\date{Milan, Italy, 22-24 June 2017}
\titlegraphic{\includegraphics[height=.7cm]{/data/Dropbox/Uni/Misc/Logos/logo.pdf}}

\begin{document}
\frame{\titlepage}
%\footnotesize
% Thank you very much, my name is Patrick Kraft and I am a PhD Candidate at the Department for Political Science at Stony Brook University. The paper I am presenting today is challenging a common finding in political science research, namely that women know significantly less about politics than men. To do this, I am proposing a new measure of political sophistication that focuses on how individuals describe their political attitudes and beliefs in their own words.
